...
<div class="container">
    <div class="row mt-5">
        <div class="col-lg-12" style="display: flex; justify-content: space-between; align-items: center;">
            <h3 class="page-header" style="margin-top: 100px; color:#2C4964; font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif; font-weight: bold;">커넥팅게시판 > 내가 쓴 글 보기	</h3>
        </div>
    </div>
</div>
<!-- my list 테스트 -->
