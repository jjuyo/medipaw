...
<div class="container">
    <div class="row mt-5">
        <div class="col-lg-12" style="display: flex; justify-content: space-between; align-items: center;">
            <h3 id="connectingBoard" class="page-header" style="margin-top: 100px; color:#2C4964; font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif; font-weight: bold; cursor: pointer;">커넥팅게시판</h3>
...
<div class="row mt-3">
    <div class="col-lg-12">
        <form action="/connecting/list" id="classificationFrm">
            ...
            <button type="submit" class="btn btn-default">분류 선택</button>
        </form>
    </div>
</div>
<!-- END 검색 타입 및 검색 키워드 -->
...
<!-- END Model 데이터 출력 -->
                ...
                <div class="row">
					<div class="col-lg-12">
		                <!-- 검색 타입 및 검색 키워드 -------------------->
	                	<form action="/connecting/list" id="searchFrm">
	                		<select name="type">
                ...
                <form action="/connecting/list" id="actionFrm">
...
<script>
// 필터링
document.getElementById('classificationFrm').addEventListener('submit', function(e) {
    // '전체'를 선택했을 때 classification 필드를 제거
    if (document.getElementById('classification').value === '') {
        document.getElementById('classification').removeAttribute('name');
    }
});

	// 자랑게시판 h3 클릭 이벤트
    $('#connectingBoard').on('click', function() {
        window.location.href = '/connecting/list';
    });
...
$(function(){
    ...
    $('#myPostsBtn').on('click', function() {
        ...
        // 'classification' 필드를 제거
        searchFrm.find("select[name='classification']").remove();
