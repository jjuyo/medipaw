...
<hr>
        ...
        <p>추가 사진
			...
			<hr>
   <form method="post"  action="/boonyang/write">
   ...
   ${bvo.age }세
    ...
    <div class="form-group row mt-4">
        <div class="col text-center">
            <a class="btn back-btn" style="margin-right:600px; width:90px;" href="/boonyang/list">목록으로</a>
        </div>
      ...
      <sec:authentication property="principal" var="p"/> 
        ...
        <div class="col text-center">
            ...
            <button data-oper="remove" class="btn rem-btn" formaction="/boonyang/remove?byno=${bvo.byno }" onclick="return delChk();">삭제</button>
        </div>
        </c:if>
        </sec:authorize>
    </div>
