    ...
    <section id="doctors" class="doctors with-margin">
      <div class="container">
		...
		<form action="/treat/modify" id="modForm">
			...
			<input type="hidden" name="hno" 	value="${view.hno }">	<!-- 즐겨찾기 등록하기 위한 번호 -->
			...
			<button data-oper="list" class="btn upd-btn" formaction="/mark/register" formmethod="post">즐겨찾기</button>
