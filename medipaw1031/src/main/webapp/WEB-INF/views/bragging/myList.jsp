...
<div class="container">
    <div class="row mt-5">
        <div class="col-lg-12" style="display: flex; justify-content: space-between; align-items: center;">
            <h3 class="page-header" style="margin-top: 100px; color:#2C4964; font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif; font-weight: bold;">자랑게시판 > 내가 쓴 글 보기	</h3>
        </div>
    </div>
</div>
<!-- my list 테스트 -->
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
               	<table class="table table-hover">
                    ...
                    <tbody>
                    <!-- Model 데이터 출력 --> 
<c:forEach items="${myList }" var="bbvo">
    <tr>
...
<!-- END Model 데이터 출력 -->
                ...
                <div class="row">
					<div class="col-lg-12">
		                <!-- 검색 타입 및 검색 키워드 -------------------->
	                	<form action="/bragging/myList" id="searchFrm">
	                		<select name="type">
                ...
                <form action="/bragging/myList" id="actionFrm">
