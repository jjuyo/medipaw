...
public class StaffController {
	...
	public String pwChange(@RequestParam("sid") String sid,@RequestParam("spw") String spw, Model model, RedirectAttributes rttr) {
	    log.info("pwChange()..................");
	    log.info(sid);
	    log.info(spw);
        String encodePw = "";
	    ...
	    rttr.addFlashAttribute("newPw", "비밀번호 변경을 완료했습니다.");
	    return "redirect:/genStaff/login";
	}
	...
	public String pwUpdate(@RequestParam("sid") String sid,@RequestParam("spw") String spw, Model model,  RedirectAttributes rttr) {
	    log.info("pwUpdate()..................");
