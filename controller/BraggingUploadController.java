...
public class BraggingUploadController {
	...
	public String getUploadPath() {
		...
		public ResponseEntity<byte[]> display(String fileName){
			File file = new File("c:\\upload\\braggingUpload\\" + fileName);
		...
		public ResponseEntity<Resource> download(String fileName){
			Resource resource = new FileSystemResource("c:\\upload\\braggingUpload\\" + fileName);
		...
		public ResponseEntity<String> deleteFile(String fileName, String type){
			...
			try {
				File file = new File("c:\\upload\\braggingUpload\\" + 
		...
		public ResponseEntity<List<BraggingAttachFileDTO>> 
		    ...
		    List<BraggingAttachFileDTO> list = new ArrayList<BraggingAttachFileDTO>();
		    ...
		    for(MultipartFile multi : uploadFile) {
		        ...
		        badto.setFileName(multi.getOriginalFilename());
		        badto.setUuid(uuid.toString());
		        badto.setUploadPath(getUploadPath());

				// Log the DTO object before saving to the session.
			    log.info("Before saving to session: " + badto);
			    ...
			    log.info("Passing to service: " + badto);
