	...
	<div class="row">
    	<div class="col-lg-12">
        	<div class="panel panel-default">
    			<div class="panel-heading">AnimalHosp Modify Page</div><br>
    			<!-- 여기다가 옆 메뉴 넣을듯 -->
    				<div class="panel-body">
						<form action="/animalhosp/modify" method="POST" accept-charset="UTF-8" onsubmit="return mergeTimeFields()">
						    <input type="hidden" id="animalhosp_no" name="animalhosp_no" value="default">
						    ...
						    <input type="time" id="animalhosp_start" name="animalhosp_start" min="00:00" max="24:00" required><br><br>
						    ...
						    <input type="hidden" id="animalhosp_open" name="animalhosp_open"><br><br>
...
$(document).ready(function() {
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            var avo = response;
            $('#animalhosp_no').val(avo.animalhosp_no);
            $('#animalhosp_name').val(avo.animalhosp_name);
            $('#hsop_roadname_address').val(avo.hsop_roadname_address);
            $('#hsop_postnum').val(avo.hsop_postnum);
            $('#animalhosp_start').val(avo.animalhosp_start);
            $('#animalhosp_close').val(avo.animalhosp_close);
            $('#animalhosp_open').val(avo.animalhosp_open);
            $('#selectedDays').val(avo.animalhosp_rest);
            $('#hsop_phonenum').val(avo.hsop_phonenum);
            $('#a_latitude').val(avo.a_latitude);
            $('#a_hardness').val(avo.a_hardness);
        },
